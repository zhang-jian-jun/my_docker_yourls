...
define( 'YOURLS_DB_PASS', getenv_docker('YOURLS_DB_PASS', 'root1234') );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', getenv_docker('YOURLS_DB_NAME', 'db_yourl') );
...
$yourls_user_passwords = [
    getenv_docker('YOURLS_USER', 'admin') => getenv_docker('YOURLS_PASS', '123456'),
];
